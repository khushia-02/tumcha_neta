...
<div id="overlay"></div>
    <div id="popupDialog">
        ...
        <div id="registrationForm" class="form-container" style="display:none;">
            <h2>Register</h2>
            <form action="../login&signup/registration_data.php" method="post" class="register">
...
if(isset($_SESSION['user'])) {
    // User is logged in, display user's profession and full name
    $user = $_SESSION['user'];
    $profession = $user['self_profession']; // Assuming you've fetched profession during login
    $full_name = $user['candidate_fullname']; // Assuming you've fetched full name during login

    // Display profession and full name
